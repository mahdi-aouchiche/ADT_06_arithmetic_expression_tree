#ifndef __ARITHMETIC_EXPRESSION_HPP__
#define __ARITHMETIC_EXPRESSION_HPP__
#include <iostream>
#include <cstdlib>
#include <stack> 
#include <fstream> 
...
class arithmeticExpression
{
  ...
  public:
    ...
    */
    ...
    /* 
      ...
      root data field. The key for the first node is 'a', 'b'
    ...
    */
    ...
    /*
      Calls the recursive visualizeTree function and generates
      the .png file using system call.
    */
  ...
  private:
    ...
    */
    ...
    /* 
      Helper function that outputs the infix notation
      of the arithmetic expression tree
    ...
    */
    ...
    /* 
      Helper function that outputs the prefix notation
      of the arithmetic expression tree
    ...
    */
    ...
    /* 
      Helper function that outputs the postfix notation
      of the arithmetic expression tree
    ...
    */
    ...
    /*
      Helper function to set up nodes to write on the .dot file
    */
    void visualizeNodes(ofstream &, TreeNode *);

    /*
      Helper function to recursively delete tree nodes in the Destructor
    */
    void delete_node(TreeNode*); 
};

#endif  // __ARITHMETIC_EXPRESSION_HPP__